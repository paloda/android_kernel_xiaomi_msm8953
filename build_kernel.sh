...
CROSS_COMPILER=/home/paloda/android/toolchains/aarch64-linux-android-4.9/bin/aarch64-linux-android-
...
FUNC_PACK()
{
        ...
        find $TEMP_DIR -iname "wlan.ko" -exec /home/paloda/android/toolchains/aarch64-linux-android-4.9/bin/aarch64-linux-strip --strip-debug {} \;
		cd $TEMP_DIR
