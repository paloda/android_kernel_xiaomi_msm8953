...
CROSS_COMPILER=/home/paloda/android/toolchains/aarch64-5.3-linaro/bin/aarch64-linux-android-
...
FUNC_PACK()
{
        ...
        find $TEMP_DIR -iname "wlan.ko" -exec /home/paloda/android/toolchains/aarch64-5.3-linaro/bin/aarch64-linux-strip --strip-debug {} \;
		cd $TEMP_DIR
